...
import { deleteVerificationFiles } from "@/lib/fs-cleanup";
...
export async function POST(req: Request) {
  try {
    ...
    if (action === "APPROVE") {
      ...
      // 🧹 RGPD : Nettoyage physique immédiat des fichiers CNI et Selfie
      await deleteVerificationFiles([
        verificationRequest.idCardPhoto1Url,
        verificationRequest.idCardPhoto2Url,
