...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // 1. Appel de l'action d'inscription
    ...
    <div className="flex min-h-screen items-center justify-center bg-black px-4 py-12">
      ...
      <div className="relative z-10 w-full max-w-md space-y-8 rounded-3xl border border-white/10 bg-black/40 p-8 backdrop-blur-2xl shadow-2xl">
        <div className="text-center">
          ...
          />
          <h2 className="mt-6 text-2xl font-bold tracking-tight text-white">Créer un compte</h2>
          <p className="mt-2 text-sm text-gray-400">Rejoignez la communauté Play Again.</p>
        </div>
        ...
        <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            <div className="relative">
              <label className="text-xs font-semibold uppercase tracking-widest text-gray-400 ml-1 mb-1.5 block">Pseudo</label>
              <div className="relative">
        ...
        <div className="relative my-10">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-transparent px-3 text-gray-500 font-medium tracking-widest">Ou s'inscrire avec</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <button
            ...
            className="flex items-center justify-center gap-3 rounded-2xl border border-white/10 bg-white/5 py-3.5 text-sm font-semibold text-white transition-all hover:bg-white/10"
          >
          ...
          <button
            ...
            className="flex items-center justify-center gap-3 rounded-2xl border border-white/10 bg-[#410093]/20 py-3.5 text-sm font-semibold text-white transition-all hover:bg-[#410093]/40"
          >
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          Déjà un compte ?{" "}
          <Link href="/auth/login" className="font-bold text-[#C6FF34] hover:brightness-110 transition-all underline-offset-4 hover:underline">
            Se connecter
          </Link>
        </p>
      </div>
