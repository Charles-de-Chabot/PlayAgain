...
import { ProfileInfosManager } from "@/components/profile/ProfileInfosManager";
          ...
          <div className="flex items-center gap-4 relative z-10 border-b border-white/10 pb-6">
            ...
            <div>
              <h1 className="text-2xl md:text-4xl font-black text-white tracking-tight uppercase italic leading-none">
                Infos <span className="text-brand-primary">Profil</span>
              </h1>
              <p className="text-xs text-zinc-400 mt-1">
                Gérez vos informations de contact et vos adresses de livraison enregistrées.
              </p>
            </div>
          </div>

          {/* Gestionnaire d'informations et d'adresses interactif */}
          <ProfileInfosManager 
            initialUser={user} 
