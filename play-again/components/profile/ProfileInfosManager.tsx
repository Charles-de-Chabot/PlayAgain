...
export function ProfileInfosManager({ initialUser, initialAddresses }: ProfileInfosManagerProps) {
  ...
  // Loading & error states for addresses
  ...
  // Synchronise addresses and user with props changes
  useEffect(() => {
  ...
  const handleUpdateContact = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error(err);
      setErrorContact(err.message || "Une erreur est survenue lors de la sauvegarde.");
    } finally {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 items-start w-full relative z-10">
      ...
      {/* ================= GAUCHE / COORDONNÉES & CRÉATION/EDITION ================= */}
      <div className="w-full lg:w-96 shrink-0 space-y-6">
        
        {/* Card 1: Coordonnées de contact (Email & Telephone) */}
        <form 
        ...
        >
          ...
          {errorContact && (
            <div className="p-3 bg-red-500/10 border border-red-500/20 rounded-xl flex items-start gap-2.5 text-red-400 text-xs">
              ...
              <p className="font-bold">{errorContact}</p>
            </div>
          )}
          ...
          {successContact && (
            <div className="p-3 bg-brand-accent/15 border border-brand-accent/30 rounded-xl flex items-center gap-2.5 text-brand-accent text-xs">
              <CheckCircle2 className="w-4.5 h-4.5 shrink-0 text-brand-accent" />
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1">
              <label className="text-[9px] font-black text-zinc-500 uppercase tracking-widest pl-1">Adresse E-mail *</label>
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full h-11 bg-black/60 border border-white/10 rounded-xl pl-10 pr-4 text-xs text-white focus:outline-none focus:border-brand-primary focus:ring-1 focus:ring-brand-primary/30 transition-all placeholder-zinc-750"
                />
            ...
            {/* Input Téléphone */}
            <div className="space-y-1">
              <label className="text-[9px] font-black text-zinc-500 uppercase tracking-widest pl-1">Numéro de téléphone</label>
              <div className="relative">
                <input
                  type="tel"
        ...
        {/* Global Error Banner for Addresses */}
        {errorMsg && (
        ...
        {/* Card 2: Interactive Address Actions / Info */}
        {!showCreateForm && !editingAddress && (
          <div className="bg-zinc-950/80 backdrop-blur-2xl rounded-3xl border border-white/10 p-5 shadow-2xl relative overflow-hidden">
            ...
            <button
              ...
              className="mt-6 w-full py-4 rounded-2xl bg-zinc-900 border border-white/10 hover:bg-zinc-800 text-white text-xs font-black uppercase tracking-widest transition-all hover:scale-[1.01] active:scale-98 cursor-pointer flex items-center justify-center gap-2 shadow-[0_0_15px_rgba(255,255,255,0.02)]"
            >
        ...
        {/* A. FORMULAIRE DE CRÉATION D'ADRESSE */}
        {showCreateForm && (
          <form 
        ...
        {/* B. FORMULAIRE D'ÉDITION D'ADRESSE */}
        {editingAddress && (
          <form 
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-white/10">
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[9px] font-black uppercase tracking-[0.22em] text-brand-primary">Mes adresses de livraison</span>
            </div>
